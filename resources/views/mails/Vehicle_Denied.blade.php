                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          <h3>
                                                          Hola: {{ $data->name }} {{ $data->surname }}                                                          </h3>
                                                          <p>
                                                            Lamentamos notificarle que su unidad no se encuentra dentro
                                                             de nuestros estandares minimos para la toma de vehículos.
                                                          </p>
                                                        ...
                                                        <td style="vertical-align: top;" valign="top">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <img
                                                                  src="https://abcars.mx/documentacion-apis/images/error.png"
                                                                  alt=""
                                                                  style="display: block !important; margin: auto !important; width: 20%;">
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                        </td>
