                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top"> <a
                                                            ...
                                                            <img src="https://carcentral.mx/test/logo.png" width="150%"
                                                              alt=""
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top"> Hola {{ ucfirst( $data->name)  }} {{ ucfirst ($data->surname )}}!<br>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          Hemos recibido la información personal que nos enviaste, sera revisada por nuestro personal y muy pronto nos contactaremos contigo.
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                      ...
                                                      <tr>
                                                        <td
                                                          style="vertical-align: top; padding: 30px 0 0 0; text-align: center;"
                                                          valign="top" align="center"> <img
                                                            src="https://abcars.mx/assets/images/abcars-images/careers.png"
                                                      ...
                                                      <tr>
                                                        <td style="vertical-align: top; padding: 5px 0;" valign="top"
                                                          align="center">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto; margin-top: 20px;">
                                                            <tbody>
                                                              <tr>
                                                                <td class="pc-header-cta-title pc-fb-font"
                                                                style="vertical-align: top; padding: 12px 0 0; text-align: center;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                                valign="top">                       Gracias por tú interes en querer unirte a nuestro equipo de <span
                                                                  style="color: rgb(254, 194, 73);">ABCars.mx</span><br>
                                                              </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
