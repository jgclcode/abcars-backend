                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top" align="center"> Hola {{ $data->name }}
                                                          {{ $data->surname }}, te hacemos llegar tus credenciales de
                                                          autenticación para iniciar sesión<br> dentro de nuestra
                                                          página. </td>   
                                                      </tr>
                                                      <tr>
                                                        <td
                                                          ...
                                                          valign="top" align="center"> <img
                                                            src="https://abcars.mx/abcars-backend/public/img/login.png" width="250"
                                                            height="250" alt=""
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-text pc-fb-font"
                                                          ...
                                                          <p>   Correo Electrónico: {{ $data->email }}</p><br>
                                                          <p>Contraseña: Hola2022@@</p>
                                                           </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
