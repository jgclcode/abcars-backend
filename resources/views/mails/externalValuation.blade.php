                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          @endphp
                                                          <p>
                                                          Recibimos la información del cliente {{ $data->name }} {{ $data->lastName }} para verificar que se
                                                          atienda su cita de valuación con fecha {{ \Carbon\Carbon::parse($data->date)->isoFormat('dddd D [de] MMMM [de] YYYY')  }} y hora {{$data->hour}}.
                                                          </p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          <p>ID del registro: {{ $data->id}}</p>
                                                          <p>Verificar la cita registrada en el apartado 'Citas valuación' del dashboard Manager.</p> 
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td class="pc-header-cta-title pc-fb-font"
                                                                  style="vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                                  valign="top"> Gracias por la atención brindada.
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                              ...
                                              <tr>
                                                <td class="pc-footer-text-s2 pc-mobile-text-centered pc-fb-font"
                                                  ...
                                                  valign="top"> <a
                                                    ...
                                                    ©️ 2024 All Right Reserved ABCars.mx</a> </td>
                                              </tr>
                                            </tbody>
                                          </table>
