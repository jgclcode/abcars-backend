                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          @endphp
                                                          <p>
                                                          Existe un nuevo registro de cotización de refacciones con id de registro {{ $data->sell_your_car_id }} favor de verificar que se
                                                          atienda dicha cotización a la brevedad posible.
                                                          </p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          <p>ID del registro: {{ $data->sell_your_car_id}}</p>
                                                          <p>Verificar el registro en el apartado 'Refacciones Vehículos' del dashboard Refacciones.</p> 
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
