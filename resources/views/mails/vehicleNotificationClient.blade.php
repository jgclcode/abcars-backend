                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top"> 
                                                          <p>
                                                            Notificación Solicitud de Financiamiento
                                                          </p>
                                                          <br>
                                                          <p>
                                                          Recibimos la información del cliente {{ $data->name }} {{ $data->surName }} para notificar que el status de la precalificación
                                                          para financiamiento de su auto se encuentra en:
                                                          @switch( $data->status )
                                                            @case('active')
                                                                <p>Activo.</p>
                                                                @break
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 15px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top">
                                                          <p>El vehículo es un:
                                                            {{ $data->brand }}
                                                            {{ $data->model }} {{ $data->year }}
                                                          </p>
                                                          <p>Con el siguiente plan de financiamiento: </p> 
                                                          <p>
                                                            Monto a Pagar:
                                                          ...
                                                          <p> 
                                                            Monto de enganche: <span style="font-weight: bold">
                                                              $ {{ $data->hitch }}
                                                            </span> 
                                                          </p>
                                                          <p>
                                                            Meses de Plazo: <span style="font-weight: bold">
                                                              {{ $data->montly_fees }} meses</span>
                                                          </p>
                                                      ...
                                                      <tr>
                                                        <td
                                                          ...
                                                          valign="top" align="center"> <img
                                                            src="https://abcars.mx/assets/images/abcars-images/buscame-banner.png"
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td class="pc-header-cta-title pc-fb-font"
                                                                  style="vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                                  valign="top"> Gracias por confiar en ABcars.mx
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
