                                                  ...
                                                  <table class="pc-header-cta-s2" border="0" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <p>
                                                        Recibimos la información del vehículo que deseas adquirir, lo
                                                        buscaremos por ti y muy pronto nos contactaremos contigo.
                                                        </p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top">
                                                          <p>El vehículo que nos encomiendas buscar es un:
                                                            {{ $data->marca }}
                                                            {{ $data->modelo }} {{ $data->anio }} {{ $data->version }}
                                                          </p>
                                                          <p>Con el siguiente plan de financiamiento: </p> 
                                                            <p> 
                                                          Método de Pago: <span style="font-weight: bold">{{ $data->tipo }}
                                                          </span> </p>
                                                          <p>
                                                            Monto a Pagar:
                                                          ...
                                                          <p>
                                                            Plazo de Adquisición: <span style="font-weight: bold">
                                                              {{ $data->plan }} </span>
                                                          </p>
