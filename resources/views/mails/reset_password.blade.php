                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top"> Recuperar cuenta<br>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          Hola {{ $data->name }} {{ $data->surname }}:                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          Ha solicitado recuperar su cuenta en abcars.mx                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                      ...
                                                      <tr>
                                                        <td
                                                          ...
                                                          valign="top" align="center"> <img
                                                            src="https://abcars.mx/abcars-backend/public/img/icon-2.png"
