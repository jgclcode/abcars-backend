                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          <p>
                                                            Le notificamos que su cita de valuacíon fue aceptada:
                                                          </p>
                                                          <p>
                                                            Lo esperamos el {{ $data->date }} a las {{ $data->hour }}, acude a tu valuación.
                                                          </p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <img
                                                                  src="https://abcars.mx/manual-abcars/images/success.png"
                                                                  alt=""
