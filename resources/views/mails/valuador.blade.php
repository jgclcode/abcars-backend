                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top">
                                                          <p>
                                                              Nueva cita de valuación
                                                          </p>
 
                                                          <p>
                                                            Datos de la unidad a evaluar:        
                                                          </p>
                                                          <p>
                                                            Marca: {{ $data->marca }} 
                                                          </p>
                                                          ...
                                                          <p>
                                                            Fecha y Hora: {{ $data->date  }} {{ $data->hour  }}Hrs         
                                                          </p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top; padding: 5px 0;" valign="top"
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td> <a
                                                                    href="https://abcars.mx/admin/valuator/vende-tu-auto"
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td> <a
                                                                    href="https://abcars.mx/admin/valuator/vende-tu-auto"
                                                                    style="line-height: 1.5; text-decoration: none; text-align: center; margin: 0; padding: 13px 17px; white-space: nowrap; border-radius: 8px; font-weight: 500; display: inline-block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; cursor: pointer; background-color: rgb(255, 0, 0);  color: #ffffff; border: 1px solid #fff;">
                                                                    Rechazar Cita</a>
                                                                </td>
                                                              </tr>
                                                            </tbody>
