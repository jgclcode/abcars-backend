                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top">
                                                          <p>
                                                            Aviso de Expiración de Apartado
                                                          </p>
                                                          <p>
                                                            Hola <b>{{ $data->name }}
                                                              {{ $data->surname }}</b>
                                                          ...
                                                          <p>
                                                            Le avisamos que el apartado que realizo por la unidad {{ $data->modelo }},
                                                             ya ha expirado, por lo que ABcars.mx le realizara una
                                                            devolución del monto que realizo por el apartado de la
                                                            misma.
                                                          </p>
                                                        </td>
                                                      </tr>
