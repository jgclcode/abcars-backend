                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top; padding: 12px 0 0; text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 22px;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top" align="center"> Notificación de Disponibilidad
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top; padding: 12px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 17px;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top"  > Es posible que el Vehículo vuelva a estar disponible si la compra no se concreta, te avisaremos en cuanto este disponible
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="text-align: justific !important;  vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 22px;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top"  > Vehículo seleccionado:  <b> {{$data->vehicle_name}} </b>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                      ...
                                                      <tr>
                                                        <td style="vertical-align: top; padding: 5px 0;" valign="top"
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td> <a href="https://abcars.mx/compra-tu-auto/detail/{{$data->vin}}"
                                                                    style="line-height: 1.5; text-decoration: none; text-align: center; margin: 0; padding: 13px 17px; white-space: nowrap; border-radius: 8px; font-weight: 500; display: inline-block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; cursor: pointer; background-color: rgb(254, 194, 73);  color: #ffffff; border: 1px solid #fff;">
                                                                    Ver vehículo</a>
                                                                </td>
                                                              </tr>
                                                            </tbody>
