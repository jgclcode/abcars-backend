                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          valign="top"> Solicitud de Trabajo<br>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          Hay una persona interesada en trabajar con nosotros, su información es la siguiente: </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td
                                                                  style="vertical-align: top; height: 24px; line-height: 24px; font-size: 24px;"
                                                                  valign="top">
                                                                  <p style="margin: 2px; font-size: 15px; line-height: 1.5;">
                                                                    <br> 
                                                                    Nombre:<span style="font-weight: bold">  {{ ucfirst( $data->name ) }} {{  ucfirst($data->surname) }} </span> <br> 
                                                                    Fecha de Nacimiento:<span style="font-weight: bold"> {{ $data->date_of_birth }} </span><br> 
                                                                    Correo Electrónico:<span style="font-weight: bold"> {{ $data->email2 }} </span> <br> 
                                                                    Teléfono:<span style="font-weight: bold"> {{ $data->phone }} </span>
                                                                </p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
