                      ...
                      <tr>
                        <td>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-header-box-s3" style="vertical-align: top; background-color: #ffffff"
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-header-box-in"
                                          style="vertical-align: top; padding: 34px 40px 55px;" valign="top">
                                          <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top"> <a
                                                            ...
                                                            <img src="https://carcentral.mx/test/logo.png"          
                                                              width="150%" alt=""
                                              ...
                                              <tr>
                                                <td style="vertical-align: top;" valign="top">
                                                  <table class="pc-spacing pc-m-header-4" border="0" cellpadding="0"
                                                    cellspacing="0"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"
                                                    width="100%">
                                                    <tbody>
                                                      <tr>
                                                        <td
                                                          style="vertical-align: top; height: 61px; line-height: 61px; font-size: 61px;"
                                                          valign="top">&nbsp;</td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                              ...
                                              <tr>
                                                <td style="vertical-align: top;" valign="top">
                                                  <table class="pc-header-cta-s2" border="0" cellpadding="0"
                                                    cellspacing="0"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"
                                                    width="100%">
                                                    <tbody>
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top;  text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 22px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top"> Notificación de Disponibilidad
                                                          <br>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          style="vertical-align: top; padding: 12px 0 0;  font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 17px !important;  line-height: 1.28; letter-spacing: -0.6px; color: #1B1B1B;"
                                                          valign="top">

                                                          Hola {{ $data->name }} {{ $data->surname }}:
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td class="pc-header-cta-title pc-fb-font"
                                                          ...
                                                          El Vehículo: {{$data->description}} ha sido vendido, te mostramos vehiculos que podrian interesarte
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td style="vertical-align: top;" valign="top">
                                                          <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td
                                                                  style="vertical-align: top; height: 24px; line-height: 24px; font-size: 24px;"
                                                                  valign="top">&nbsp;</td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <div style="width: 100%; text-align: center">            
                                                            <!----->
                                                            <div class="cards" style="margin: 80px auto;max-width: 960px; text-align: center;">
                                                                @foreach( $data->vehicles as $vehicle )
                                                                <div class="card" style="background: #FFFFFF; display: inline-block; margin: 8px; max-width: 300px; perspective: 1000; position: relative; text-align: left; transition: all 0.3s 0s ease-in; width: 300px; z-index: 1;">
                                                                    <div class="card__image-holder" style="background: rgba(0,0,0,0.1); height: 0; padding-bottom: 75%;">
                                                                        @if(is_object($vehicle->vehicle_images->first()) && !is_null($vehicle->vehicle_images->first()))         
                                                                            @if( $vehicle->vehicle_images->first()->external_website == "yes" )
                                                                                <img class="card__image" src="{{ $vehicle->vehicle_images->first()->path }}" alt="wave" style="max-width: 300px;" />
                                                                            @else
                                                                                <img class="card__image" src="https://automotrizbalderrama.com/inventory/pre_owned_vehicle_image/image/clear/{{ $vehicle->vehicle_images->first()->path }}" alt="wave" style="max-width: 300px;" />
                                                                            @endif
                                                                        @else
                                                                            <img class="card__image" src="https://abcars.mx/abcars-backend/api/image_vehicle/vacio" alt="wave" style="max-width: 300px;" />
                                                                        @endif                                    
                                                                    </div>
                                                                    <div class="card-title" style="background: #FFFFFF; padding: 6px 15px 10px; position: relative; z-index: 0;">
                                                                        <h2>
                                                                            {{ $vehicle->name }} <small>${{ $vehicle->priceList }}</small>
                                                                        </h2>
                                                                    </div>
                                    
                                                                    <div>
                                                                        <a style="text-align: center; text-decoration: none; border-radius: 5px; padding: 11px 23px; margin: 0px 5px; color: white; background-color: rgb(254, 194, 73); display: block; width: 245px !important; " href="https://abcars.mx/compra-tu-auto/detail/{{$vehicle->vin}}">Comprar ahora</a>
                                                                    </div>
                                                                </div>
                                                                @endforeach
                                                            </div>
                        ...
                        <![endif]-->
                                          <table class="pc-footer-row-col" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                              <tr>
                                                <td class="pc-footer-text-s2 pc-mobile-text-centered pc-fb-font"
                                                  ...
                                                  valign="top"> <a
                                                    style="text-decoration: none; color: rgb(0, 0, 0); cursor: text;">Copyright
                                                    ©️ 2021 All Right Reserved ABCars.mx</a> </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                          <!--[if (gte mso 9)|(IE)]>
